...
//              console.log("----------------------------------------------------------------------------");
                ...
                if (ui.draggable[0].id == "hhjmultimeterRed-hotspot" && multimeterService.Mdata.multimeterblackPosition != $(this).attr("wybredPosition")) {
                    $("#path_Red").css("stroke", "#db3040");
//                  $("#hhjmultimeterRed").css("top", "" + (parseInt($(this).attr("h_top")) - 178) + "px");
//                  $("#hhjmultimeterRed").css("left", "" + (parseInt($(this).attr("h_left")) - 1) + "px");
//                  $("#hhjmultimeterRed-hotspot").css("top", "" + (parseInt($(this).attr("h_top")) + 39) + "px");
//                  $("#hhjmultimeterRed-hotspot").css("left", "" + (parseInt($(this).attr("h_left")) - 1) + "px");
                    
                    $("#hhjmultimeterRed").css("top", "" + (parseInt($(this).css("top")) - 179) + "px");
                    $("#hhjmultimeterRed").css("left", "" + (parseInt($(this).css("left")) - 1) + "px");
                    $("#hhjmultimeterRed-hotspot").css("top", "" + (parseInt($(this).css("top")) + 39) + "px");
                    $("#hhjmultimeterRed-hotspot").css("left", "" + (parseInt($(this).css("left")) - 1) + "px");
...
//                  console.log("%c 红表笔的触发值----------" + multimeterService.Mint.In1MultiLogic_x_Red_x_x, "color: #cc0000");
                ...
                if (ui.draggable[0].id == "hhjmultimeterBlack-hotspot" && multimeterService.Mdata.multimeterredPosition != $(this).attr("wybblackPosition")) {
                    $("#path_black").css("stroke", "#656261");
//                  $("#hhjmultimeterBlack").css("top", "" + (parseInt($(this).attr("h_top")) - 178) + "px");
//                  $("#hhjmultimeterBlack").css("left", "" + (parseInt($(this).attr("h_left")) - 1) + "px");
//                  $("#hhjmultimeterBlack-hotspot").css("top", "" + (parseInt($(this).attr("h_top")) + 39) + "px");
//                  $("#hhjmultimeterBlack-hotspot").css("left", "" + (parseInt($(this).attr("h_left")) - 1) + "px");
                   
                    $("#hhjmultimeterBlack").css("top", "" + (parseInt($(this).css("top")) - 179) + "px");
                    $("#hhjmultimeterBlack").css("left", "" + (parseInt($(this).css("left")) - 1) + "px");
                    $("#hhjmultimeterBlack-hotspot").css("top", "" + (parseInt($(this).css("top")) + 39) + "px");
                    $("#hhjmultimeterBlack-hotspot").css("left", "" + (parseInt($(this).css("left")) - 1) + "px");
...
//      $("#path_Red").attr("d", "M" + multimeterService.Mdata.Param_redx + " " + multimeterService.Mdata.Param_redy + " C" + multimeterService.Mdata.Param_redx + " " + multimeterService.Mdata.Param_redy + " " + multimeterService.Mdata.Param_redcx + " " + multimeterService.Mdata.Param_redcy + " " + multimeterService.Mdata.Param_redpx + " " + multimeterService.Mdata.Param_redpy);
		...
		//车上位置和车上模型编码都要置为0
        multimeterService.Mdata.multimeterblackPosition = 0;
...
//      console.info("恢复的黑表笔的触发值----------" + multimeterService.Mint.In1MultiLogic_x_Black_x_x);
		...
		//车上位置和车上模型编码都要置为0
        multimeterService.Mdata.multimeterredPosition = 0;
...
//      console.log("%c 恢复的红表笔的触发值----------" + multimeterService.Mint.In1MultiLogic_x_Red_x_x, "color: #cc0000");
    ...
    multimeterService.Mint = {
        ...
        In1MultiLogic_x_ACVlt_x_x: '0',//电压交流
        In1MultiLogic_x_DCVlt_x_x: '0',//电压直流
        In1MultiLogic_x_DCmVlt_x_x: '0',//电压没用
        ...
        In1MultiLogic_x_Red_x_x: '0',//红表笔输入
        In1MultiLogic_x_Black_x_x: '0'//黑表笔输入

    };
        multimeterService.Mout = {
            Out1MultiLogic_x_ToScreen_x_x: '0',//万用表读数显示参数
        }
    //测量值的记录
    multimeterService.recordMeasure=function(){
        //红表笔落下时满足条件记录数据(黑表笔接地并且在v档)
        if((multimeterService.Mint.In1MultiLogic_x_Black_x_x=='4')&&(multimeterService.Mint.In1MultiLogic_x_DCVlt_x_x=='1')){
            //红表笔刚好在记录点上(主开关电压)
            if((multimeterService.Mint.In1MultiLogic_x_Black_x_x=='4')||(multimeterService.Mint.In1MultiLogic_x_Red_x_x=='4')||
                (multimeterService.Mint.In1MultiLogic_x_Red_x_x=='3440')|| (multimeterService.Mint.In1MultiLogic_x_Red_x_x=='3442')||
                (multimeterService.Mint.In1MultiLogic_x_Red_x_x=='3444')|| (multimeterService.Mint.In1MultiLogic_x_Red_x_x=='3446')
            ){
                $rootScope.recordHistory("HE059");
            }
            //红表笔刚好在记录点上(H2开关电压)
            if((multimeterService.Mint.In1MultiLogic_x_Black_x_x=='4')||(multimeterService.Mint.In1MultiLogic_x_Red_x_x=='3448')||
                (multimeterService.Mint.In1MultiLogic_x_Red_x_x=='3450') ||(multimeterService.Mint.In1MultiLogic_x_Red_x_x=='3452')||
                (multimeterService.Mint.In1MultiLogic_x_Red_x_x=='3454')
                ){
                $rootScope.recordHistory("HE060");
            }
            //红表笔刚好在记录点上(H3开关电压)
            if((multimeterService.Mint.In1MultiLogic_x_Black_x_x=='4')||(multimeterService.Mint.In1MultiLogic_x_Red_x_x=='3456')){
                $rootScope.recordHistory("HE061");
            }

        }else{}
        //黑表笔落下时满足条件记录数据(红表笔接地并且在v档)
        if((multimeterService.Mint.In1MultiLogic_x_Red_x_x=='4')&&(multimeterService.Mint.In1MultiLogic_x_DCVlt_x_x=='1')){

            //红表笔刚好在记录点上(主开关电压)
            if((multimeterService.Mint.In1MultiLogic_x_Black_x_x=='4')||(multimeterService.Mint.In1MultiLogic_x_Black_x_x=='3440')||
                (multimeterService.Mint.In1MultiLogic_x_Black_x_x=='3442')||(multimeterService.Mint.In1MultiLogic_x_Black_x_x=='3444')||
                (multimeterService.Mint.In1MultiLogic_x_Black_x_x=='3446')){
                $rootScope.recordHistory("HE059");
            }
            //红表笔刚好在记录点上(H2开关电压)
            if((multimeterService.Mint.In1MultiLogic_x_Black_x_x=='4')||(multimeterService.Mint.In1MultiLogic_x_Black_x_x=='3448')||
                (multimeterService.Mint.In1MultiLogic_x_Black_x_x=='3450') ||(multimeterService.Mint.In1MultiLogic_x_Black_x_x=='3452')||
                (multimeterService.Mint.In1MultiLogic_x_Black_x_x=='3454')
            ){
                $rootScope.recordHistory("HE060");
            }
            //红表笔刚好在记录点上(H3开关电压)
            if((multimeterService.Mint.In1MultiLogic_x_Black_x_x=='4')||(multimeterService.Mint.In1MultiLogic_x_Black_x_x=='3456')){
                $rootScope.recordHistory("HE061");
            }
        }else{}
    }
