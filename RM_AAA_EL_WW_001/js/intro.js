...
var jInfo=[
	...
	{
		step:"#step2",
		sInfoText:"<b>万用表 </b>通过点击相应的表笔,然后点击想要测量的点，万用表表笔就连接到相应的点上，可以用于测量电路及一些元件的电阻、电压值。<br><br><b>汽车诊断仪 </b>为了使用诊断仪，必须打开点火开关，否则诊断仪与电控单元不能通讯。诊断仪有三项功能：数据流（在这个功能下，可以读出传感器和执行器的参数），读取故障码（使用这个功能可以读取存储的故障码），清除故障码（使用这个功能可以删除存储的故障码）。 <br><br>",
